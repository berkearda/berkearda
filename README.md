...
- [ETH Data Science Lab](https://github.com/berkearda/ETH-Data-Science-Lab): WinCLIP anomaly detection for industrial visual inspection
- Plant point cloud segmentation: organ-level 3D segmentation for plant phenotyping, WACV 2023 Workshop

## Tech

`Python` `PyTorch` `Hugging Face` `vLLM` `LLM APIs` `RAG` `Agents` `SLURM/HPC` `Docker` `SQL` `OpenCV` `Open3D`
